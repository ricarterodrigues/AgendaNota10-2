...
import static com.ifpb.agendanota10.visao.TelaInicial.atualizarTabela;
...
public class TelaEditarCompromisso extends javax.swing.JFrame {
    ...
    private static Compromisso oldComp = new Compromisso();
    
    public TelaEditarCompromisso(Compromisso comp) {
        ...
        oldComp.setAgenda(comp.getAgenda());
        oldComp.setData(comp.getData());
        oldComp.setHora(comp.getHora());
        oldComp.setDescricao(comp.getDescricao());
        oldComp.setLocal(comp.getLocal());
        oldComp.setEmail(comp.getEmail());
        ...
        jSpinner1.setValue(comp.getHora().getHour());
        jSpinner2.setValue(comp.getHora().getMinute());
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Editar Compromisso");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (daoComp.update(comp,oldComp)) {
                ...
                TelaGerenciarCompromisso.atualizarTabela();
                atualizarComboBox();
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this.getContentPane(),
            ...
            JOptionPane.showMessageDialog(this.getContentPane(), "Não há agendas", "Error", JOptionPane.ERROR_MESSAGE);
